...
# Download LescatitSite from github release and extract to the /var/www directory
echo -e "${GREEN}Download LescatitSite from github release${ENDCOLOR}"
LATEST_RELEASE=$(curl -s https://api.github.com/repos/mtnmunuklu/LescatitSite/releases/latest \
