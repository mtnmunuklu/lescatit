...
func (x *GetURLsDataRequest) GetUrls() []string {
	if x != nil {
		return x.Urls
	}
	return nil
...
type CrawlRequest struct {
	...
	AllowedDomains []string `protobuf:"bytes,4,rep,name=allowedDomains,proto3" json:"allowedDomains,omitempty"`
	// DisallowedDomains is a domain blacklist.
	DisallowedDomains []string `protobuf:"bytes,5,rep,name=disallowedDomains,proto3" json:"disallowedDomains,omitempty"`
	// DisallowedURLFilters is a list of regular expressions which restricts
	// visiting URLs. If any of the rules matches to a URL the
	// request will be stopped. DisallowedURLFilters will
	// be evaluated before URLFilters
	// Leave it blank to allow any URLs to be visited
	DisallowedUrlFilters []string `protobuf:"bytes,6,rep,name=disallowedUrlFilters,proto3" json:"disallowedUrlFilters,omitempty"`
	// URLFilters is a list of regular expressions which restricts
	// visiting URLs. If any of the rules matches to a URL the
	// request won't be stopped. DisallowedURLFilters will
	// be evaluated before URLFilters
	// Leave it blank to allow any URLs to be visited
	UrlFilters []string `protobuf:"bytes,7,rep,name=urlFilters,proto3" json:"urlFilters,omitempty"`
	// URLRevisit allows multiple downloads of the same URL
	UrlRevisit bool `protobuf:"varint,8,opt,name=urlRevisit,proto3" json:"urlRevisit,omitempty"`
	// MaxBodySize is the limit of the retrieved response body in bytes.
	// 0 means unlimited.
	// The default value for MaxBodySize is 10MB (10 * 1024 * 1024 bytes).
	MaxBodySize int64 `protobuf:"varint,9,opt,name=maxBodySize,proto3" json:"maxBodySize,omitempty"`
	// robotsTxt allows the Collector to ignore any restrictions set by
	// the target host's robots.txt file.  See http://www.robotstxt.org/ for more
	// information.
	RobotsTxt bool `protobuf:"varint,10,opt,name=robotsTxt,proto3" json:"robotsTxt,omitempty"`
}
...
var file_crawl_proto_rawDesc = []byte{
	...
	0x25, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x55, 0x52, 0x4c, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x28, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x55, 0x52, 0x4c,
	...
	0x22, 0x3a, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x55, 0x52, 0x4c, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65,
	...
	,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x35, 0x0a, 0x08, 0x43, 0x72, 0x61, 0x77, 0x6c, 0x55, 0x52,
	0x4c, 0x12, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x61, 0x77, 0x6c, 0x55, 0x52, 0x4c, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x61, 0x77,
	0x6c, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x09,
	0x43, 0x72, 0x61, 0x77, 0x6c, 0x55, 0x52, 0x4c, 0x73, 0x12, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x43,
	0x72, 0x61, 0x77, 0x6c, 0x55, 0x52, 0x4c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x14, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x61, 0x77, 0x6c, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x73,
...
var file_crawl_proto_depIdxs = []int32{
	4, // 0: pb.CrawlURLRequest.crawlRequest:type_name -> pb.CrawlRequest
	4, // 1: pb.CrawlURLsRequest.crawlRequest:type_name -> pb.CrawlRequest
	1, // 2: pb.CrawlService.GetURLData:input_type -> pb.GetURLDataRequest
	2, // 3: pb.CrawlService.GetURLsData:input_type -> pb.GetURLsDataRequest
	5, // 4: pb.CrawlService.CrawlURL:input_type -> pb.CrawlURLRequest
	6, // 5: pb.CrawlService.CrawlURLs:input_type -> pb.CrawlURLsRequest
	3, // 6: pb.CrawlService.GetURLData:output_type -> pb.GetURLDataResponse
	3, // 7: pb.CrawlService.GetURLsData:output_type -> pb.GetURLDataResponse
	7, // 8: pb.CrawlService.CrawlURL:output_type -> pb.CrawlURLResponse
	7, // 9: pb.CrawlService.CrawlURLs:output_type -> pb.CrawlURLResponse
